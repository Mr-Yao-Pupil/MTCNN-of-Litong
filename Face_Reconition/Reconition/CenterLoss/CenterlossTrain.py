from Reconition.CenterLoss.TrainNet import *
...
save_path = r'F:\咕泡学院项目实战\Face_Reconition\ModuleFiles\CenterLoss.pt'
...
while True:
    ...
    for i, (x, y) in enumerate(train_loader):
        feature, outputs = net(x.cuda())
        ys = y.cuda()

        loss = net.getloss(outputs, feature, ys)
