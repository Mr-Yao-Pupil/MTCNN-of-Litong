...
class Detector:
    ...
    def __init__(self, pnet_param='F:\咕泡学院项目实战\Face_Reconition\ModuleFiles\PNet.pt',
                 rnet_param='F:\咕泡学院项目实战\Face_Reconition\ModuleFiles\RNet.pt',
                 onet_param='F:\咕泡学院项目实战\Face_Reconition\ModuleFiles\ONet.pt',
                 isCuda=True):
    ...
    def __rnet_detect(self, image, pnet_boxes):
        ...
        _pnet_boxes = utils.to_square(pnet_boxes)  # ★给p网络输出的框，找出中心点，沿着最大边长的两边扩充成“正方形”，再抠图
    ...
    def __onet_detect(self, image, rnet_boxes):
        ...
        _rnet_boxes = utils.to_square(rnet_boxes)  # 给r网络输出的框，找出中心点，沿着最大边长的两边扩充成“正方形”
        ...
        print(boxes)
        return utils.nms(np.array(boxes), isMin=True, thresh=o_nms)  # 用最小面积的IOU；原o_nms(IOU)为小于0.7的框被保留下来


if __name__ == '__main__':
    # 多张图片检测
    image_path = r'F:\Datasets\明星人脸数据集\周杰伦'
